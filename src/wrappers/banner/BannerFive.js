        ...
        <div className="row">
            ...
            <div className="row">
              ...
              <div className="col-lg-12">
                <div className="single-banner mb-20">
                  <Link to={process.env.PUBLIC_URL + "/shop-grid-standard"}>
                    <img
                      src="https://thumbs.dreamstime.com/b/shopping-paper-bag-different-groceries-light-blue-background-flat-lay-space-text-156220126.jpg"
                      // src={
                      //   process.env.PUBLIC_URL +
          ...
          <div className="col-lg-4 col-md-6">
            <div className="single-banner mb-20">
              <Link to={process.env.PUBLIC_URL + "/shop-grid-standard"}>
                <img
                  src="https://www.hybridlinings.com.au/wp-content/uploads/2021/11/fullsizeoutput_1df3-683x1024-1.jpeg"
                  // src={
            ...
            <div className="row">
              <div className="col-lg-12 col-md-6">
                <div className="single-banner mb-20">
                  <Link to={process.env.PUBLIC_URL + "/shop-grid-standard"}>
                    <img
                      src="https://thumbs.dreamstime.com/b/full-paper-bag-different-groceries-wooden-background-top-view-79775184.jpg"
                      // src={
                      //   process.env.PUBLIC_URL +
              ...
              <div className="col-lg-12 col-md-6">
                <div className="single-banner mb-20">
                  <Link to={process.env.PUBLIC_URL + "/shop-grid-standard"}>
                    <img
                      src="https://thumbs.dreamstime.com/b/products-essentials-donation-placed-white-background-set-includes-dry-foods-bread-fruits-vegetables-180743992.jpg"
                      // src={
                      //   process.env.PUBLIC_URL +
